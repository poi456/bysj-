...
<body>
<div class="x-body">
    <form action="<%=request.getContextPath()%>/account/CKins" class="layui-form">
        <div class="layui-form-item">
            <label for="username" class="layui-form-label">
                <span class="x-red">*</span>超市名
            </label>
            <div class="layui-input-inline">
                <input type="text" id="username" name="cangkuming" required="" lay-verify="required"
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text"  name="shuliang" required="" lay-verify="pass"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text"  name="danjia" required="" lay-verify="pass"
                       autocomplete="off" class="layui-input">
            </div>
        </div>
